...
change (via live coding or any other reason). The *concretized metadata* may
infact be stored as files on disk (as opposed to present in the lisp image) and
*reified* by the engine at startup time.

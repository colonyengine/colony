...
(define-scene noise-test ()
  ...
  (@perlin-improved-3d
   ((transform :translation/current (flm:vec3 -110 202.5 0)
               :scale/current (flm:vec3 90 90 0))
    (mesh :location '((:core :mesh) "plane.glb"))
    (mesh-renderer :material '(noise-test
  ...
  (@hermite-3d
   ((transform :translation/current (flm:vec3 -540 -22.5 0)
               :scale/current (flm:vec3 90 90 0))
    (mesh :location '((:core :mesh) "plane.glb"))
    (mesh-renderer :material '(noise-test
  ...
  (@simplex-perlin-3d
   ((transform :translation/current (flm:vec3 -325 -22.5 0)
               :scale/current (flm:vec3 90 90 0))
    (mesh :location '((:core :mesh) "plane.glb"))
    (mesh-renderer :material '(noise-test
  ...
  (@simplex-cellular-3d
   ((transform :translation/current (flm:vec3 -110 -22.5 0)
               :scale/current (flm:vec3 90 90 0))
    (mesh :location '((:core :mesh) "plane.glb"))
    (mesh-renderer :material '(noise-test
  ...
  (@value-hermite-3d
   ((transform :translation/current (flm:vec3 -540 -247.5 0)
               :scale/current (flm:vec3 90 90 0))
    (mesh :location '((:core :mesh) "plane.glb"))
    (mesh-renderer :material '(noise-test
  ...
  (@value-perlin-3d
   ((transform :translation/current (flm:vec3 -325 -247.5 0)
               :scale/current (flm:vec3 90 90 0))
    (mesh :location '((:core :mesh) "plane.glb"))
    (mesh-renderer :material '(noise-test
  ...
  (@polkadot-3d
   ((transform :translation/current (flm:vec3 -110 -247.5 0)
               :scale/current (flm:vec3 90 90 0))
    (mesh :location '((:core :mesh) "plane.glb"))
    (mesh-renderer :material '(noise-test

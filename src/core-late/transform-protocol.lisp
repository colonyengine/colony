...
(defgeneric get-translation (object &key)
  (:method ((object comp:transform) &key copy)
    (comp::%get-translation object copy))
  (:method ((object actor) &key copy)
    (let ((transform (component-by-type object 'comp:transform)))
      (comp::%get-translation transform copy)))
  (:method ((object component) &key copy)
    (a:if-let ((actor (actor object)))
      (let ((transform (component-by-type actor 'comp:transform)))
        (comp::%get-translation transform copy))
...
(defgeneric get-rotation (object &key)
  (:method ((object comp:transform) &key copy)
    (comp::%get-rotation object copy))
  (:method ((object actor) &key copy)
    (let ((transform (component-by-type object 'comp:transform)))
      (comp::%get-rotation transform copy)))
  (:method ((object component) &key copy)
    (a:if-let ((actor (actor object)))
      (let ((transform (component-by-type actor 'comp:transform)))
        (comp::%get-rotation transform copy))
...
(defgeneric get-scale (object &key)
  (:method ((object comp:transform) &key copy)
    (comp::%get-scale object copy))
  (:method ((object actor) &key copy)
    (let ((transform (component-by-type object 'comp:transform)))
      (comp::%get-scale transform copy)))
  (:method ((object component) &key copy)
    (a:if-let ((actor (actor object)))
      (let ((transform (component-by-type actor 'comp:transform)))
        (comp::%get-scale transform copy))
...
(defgeneric translate (object vec &key)
  (:method ((object comp:transform) vec &key (space :model) replace instant)
...
(defgeneric rotate (object quat &key)
  (:method ((object comp:transform) quat &key (space :model) replace instant)
...
is returned.")
  (:method ((object comp:transform) point &key (space :model))
...
returned.")
  (:method ((object comp:transform) vector &key (space :model))
...
M:VEC3 is returned.")
  (:method ((object comp:transform) direction &key (space :model))

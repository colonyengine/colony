...
(define-function perlin/derivs ((point :vec2)
  ...
  (mvlet* ((cell (floor point))
           ...
           (blend (shaping:quintic-curve/interpolate-derivative
                   (.xy vecs)))
           (out (+ dotval0-grad0
                   (* (.x blend) k0-gk0)
...
(define-function perlin-surflet ((point :vec2)
  ...
  (mvlet* ((cell (floor point))
           ...
           (out (dot (shaping:falloff-squared-c2
...
(define-function perlin/derivs ((point :vec3)
  ...
  (mvlet* ((cell (floor point))
           ...
           (k6-gk6 (- (- dot7-grad7 dot6-grad6) (- dot5-grad5 dot4-grad4)
                      k3-gk3))
           (blend (shaping:quintic-curve vec))
           (blend-deriv (shaping:quintic-curve/derivative vec))
           (out (+ dot0-grad0
...
(define-function perlin-surflet ((point :vec3)
  ...
  (mvlet* ((cell (floor point))
           ...
           (out (* (+ (dot (shaping:falloff-squared-c2
                           ...
                           temp1)
                      (dot (shaping:falloff-squared-c2

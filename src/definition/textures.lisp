...
(tex:define-texture debug-texture (:texture-2d clamp-all-edges)
  ...
  (:data #((:virality.engine/texture "debug-0.png")
           (:virality.engine/texture "debug-1.png")
           (:virality.engine/texture "debug-2.png")
           (:virality.engine/texture "debug-3.png")
           (:virality.engine/texture "debug-4.png")
           (:virality.engine/texture "debug-5.png")
           (:virality.engine/texture "debug-6.png")
           (:virality.engine/texture "debug-7.png")
           (:virality.engine/texture "debug-8.png")
           (:virality.engine/texture "debug-9.png")
           (:virality.engine/texture "debug-10.png"))))

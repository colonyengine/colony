...
(defclass game-object ()
  ((%id :accessor id
   ...
   ;; A view into the components instances.  Keyed by (reference to)
   ;; instance, value is list of (reference to) instances (that are
   ;; located in the components slot of this object). It is ok if the
   ;; value is a list since it'll generally be the case noone searches
   ;; in this list for anything on a common basis.

...
(defun perlin ((point :vec2))
  (perlin point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun perlin/derivs ((point :vec2)
  ...
  (mvlet* ((cell (floor point))
           ...
           (blend (quintic-curve/interpolate-derivative (.xy vecs)))
           (out (+ dotval0-grad0
                   (* (.x blend) k0-gk0)
...
(defun perlin/derivs ((point :vec2))
  (perlin/derivs point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun perlin-surflet ((point :vec2)
  ...
  (mvlet* ((cell (floor point))
           ...
           (out (dot (falloff-squared-c2 (min (vec4 1) vecs-squared))
...
(defun perlin-surflet ((point :vec2))
  (perlin-surflet point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun perlin-surflet/derivs ((point :vec2))
  (perlin-surflet/derivs point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun perlin-improved ((point :vec2))
  (perlin-improved point (lambda ((x :vec2)) (fast32 x))))
...
(defun perlin ((point :vec3))
  (perlin point (lambda ((x :vec3)) (fast32/3-per-corner x))))
...
(defun perlin/derivs ((point :vec3)
  ...
  (mvlet* ((cell (floor point))
           ...
           (blend (quintic-curve vec))
           (blend-deriv (quintic-curve/derivative vec))
           (out (+ dot0-grad0
...
(defun perlin/derivs ((point :vec3))
  (perlin/derivs point (lambda ((x :vec3)) (fast32/3-per-corner x))))
...
(defun perlin-surflet ((point :vec3)
  ...
  (mvlet* ((cell (floor point))
           ...
           (out (* (+ (dot (falloff-squared-c2
                            (min (vec4 1) (+ vecs-squared (.z vec))))
                           temp1)
                      (dot (falloff-squared-c2
...
(defun perlin-surflet ((point :vec3))
  (perlin-surflet point (lambda ((x :vec3)) (fast32/3-per-corner x))))
...
(defun perlin-surflet/derivs ((point :vec3))
  (perlin-surflet/derivs point (lambda ((x :vec3)) (fast32/3-per-corner x))))
...
(defun perlin-improved ((point :vec3))
  (perlin-improved point (lambda ((x :vec3)) (fast32 x))))
...
(defun perlin ((point :vec4))
  (perlin point (lambda ((x :vec4)) (fast32-2/4-per-corner x))))

...
(defun simplex-perlin ((point :vec2))
  (simplex-perlin point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun simplex-perlin/derivs ((point :vec2))
  (simplex-perlin/derivs point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun simplex-cellular ((point :vec2))
  (simplex-cellular point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun simplex-polkadot ((point :vec2)
                         (radius :float)
                         (max-dimness :float))
  (simplex-polkadot point radius max-dimness (lambda ((x :vec2)) (fast32 x))))

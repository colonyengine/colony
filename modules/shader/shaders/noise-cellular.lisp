...
(defun cellular ((point :vec2))
  (cellular point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun cellular/derivs ((point :vec2))
  (cellular/derivs point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun cellular-fast ((point :vec2))
  (cellular-fast point (lambda ((x :vec2)) (fast32/2-per-corner x))))
...
(defun cellular ((point :vec3))
  (cellular point (lambda ((x :vec3)) (fast32/3-per-corner x))))
...
(defun cellular/derivs ((point :vec3))
  (cellular/derivs point (lambda ((x :vec3)) (fast32/3-per-corner x))))
...
(defun cellular-fast ((point :vec3))
  (cellular-fast point (lambda ((x :vec3)) (fast32/3-per-corner x))))

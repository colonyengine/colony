...
(fu:eval-always
  (defun %make-accessor-symbol (prefix &rest args)
    (fu:format-symbol (symbol-package prefix) "~@:(~{~a~}~)" (cons prefix args))))

...
(define-function collider/sphere/geom (&uniform
  ...
  (let* ((mvp (* proj view model)))
    ...
    ;; TODO: Ok, it was REALLY EASY to draw the sphere collider like a spiral,
    ;; but it clearly needs a better visualization. I'm thinking a line-strip
    ;; that goes around each plane around the origin. It turns out if you do
    ;; some math you can trace a line strip across the sphere so it cuts it
    ;; into eights.
    (let ((iterations 256))

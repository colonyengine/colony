...
(defun test-axis-directions (self)
  (let* ((actor (v:actor self))
    ...
    (unless (u:href (test-performed self) test-type)
      (let ((forward (comp.transform:transform-forward actor-transform))
            (backward (comp.transform:transform-backward actor-transform))
            (up (comp.transform:transform-up actor-transform))
            (down (comp.transform:transform-down actor-transform))
            (right (comp.transform:transform-right actor-transform))
            (left (comp.transform:transform-left actor-transform)))
...
(defun test-transform-point-api (self)
  ...
  (let* ((actor (v:actor self))
         ...
         (local->world
           (comp.transform:transform-point actor-transform
                                           object-space-point))
         (world->local
           (comp.transform:inverse-transform-point actor-transform
                                                   world-space-point)))
...
(defun test-transform-vector-api (self)
  ...
  (let* ((actor (v:actor self))
         ...
         (local->world
           (comp.transform:transform-vector actor-transform
                                            object-space-vector))
         (world->local
           (comp.transform:inverse-transform-vector actor-transform
                                                    world-space-vector)))
...
(defun test-transform-direction-api (self)
  (let* ((actor (v:actor self))
         ...
         (local->world
           (comp.transform:transform-direction actor-transform
                                               object-space-direction))
         (world->local
           (comp.transform:inverse-transform-direction actor-transform
...
(v:define-prefab "collision-smoke-test" (:library examples)
  ...
  ("rot-0-center"
   (comp.transform:transform :translate (v3:vec -2 0 0)
...
"
  (("camera" :copy "/cameras/perspective")
   (comp.camera:camera (:policy :new-args) :zoom 7))

  ("thingy"
   ;; NOTE: The 5 0 0 is specific to the unit-test-transform-api tests.
   (comp.transform:transform :translate (v3:vec 5 0 0))
...
world space for a particular transform."
  ...
  ("right"
   (comp.transform:transform :translate (v3:vec 1 0 0))
   ("up"
    (comp.transform:transform :translate (v3:vec 0 1 0))
    ("back"
     (comp.transform:transform :translate (v3:vec 0 0 1))
     ("mark"
...
be made bigger. to accomodate it. Maybe some fragments too when it hits..."
  ...
  ("left-gate"
   (comp.transform:transform :translate (v3:vec -1.15 2 -.1))
   (comp.mesh.static:static-mesh :location '((:core :mesh) "plane.glb"))
   (comp.render:render :material '2d-wood)
   (comp.col:sphere :display-id "Left-Gate"
                    :visualize t
                    :on-layer :ground))
  ...
  ("right-gate"
   ...
   (comp.mesh.static:static-mesh :location '((:core :mesh) "plane.glb"))
   (comp.render:render :material '2d-wood)
   (comp.col:sphere :display-id "Right-Gate"
                    :visualize t
                    :on-layer :ground))

  ("stone"
   (comp.transform:transform :translate (v3:vec 0 5 0)
                   :scale 0.5
   ...
   (comp.col:sphere :display-id "Stone"
                    :visualize t
                    :on-layer :player
                    :referent (v:ref :self
  ...
  ("ground"
   (comp.transform:transform :translate (v3:vec 0 -2 0.1))
   (comp.mesh.static:static-mesh :location '((:core :mesh) "plane.glb"))
   (comp.col:sphere :display-id "Ground"
                    :visualize t
                    :on-layer :ground
                    :center (v3:zero)
                    :radius 1)
...
actually are. You have to view the results to see the colliders lighting up."
  ...
  ("upper-left"
   (comp.transform:transform :translate (v3:vec -2 2 -0.1))
   (comp.mesh.static:static-mesh :location '((:core :mesh) "plane.glb"))
   (comp.render:render :material '2d-wood)
   (comp.col:sphere :display-id "Upper-Left"
                    :visualize t
                    :on-layer :ground))
  ("upper-right"
   (comp.transform:transform :translate (v3:vec 2 2 -0.1))
   (comp.mesh.static:static-mesh :location '((:core :mesh) "plane.glb"))
   (comp.render:render :material '2d-wood)
   (comp.col:sphere :display-id "Upper-Right"
                    :visualize t
                    :on-layer :ground))
  ("lower-left"
   (comp.transform:transform :translate (v3:vec -2 -2 -0.1))
   (comp.mesh.static:static-mesh :location '((:core :mesh) "plane.glb"))
   (comp.render:render :material '2d-wood)
   (comp.col:sphere :display-id "Lower-Left"
                    :visualize t
                    :on-layer :ground))
  ("lower-right"
   (comp.transform:transform :translate (v3:vec 2 -2 -0.1))
   (comp.mesh.static:static-mesh :location '((:core :mesh) "plane.glb"))
   (comp.render:render :material '2d-wood)
   (comp.col:sphere :display-id "Lower-Right"
                    :visualize t
                    :on-layer :ground))
  ("stone"

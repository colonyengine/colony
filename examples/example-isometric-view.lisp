...
(v:define-prefab "isometric-view" (:library examples)
  ("camera-handle"
   (comp.transform:transform :rotate/inc (q:orient :local :y (/ pi 4)))
   ("iso"
  ...
  #++(("camera" :copy "/cameras/iso")
      ("camera"
       (comp.camera:camera (:policy :new-args) :clip-near .1
                                               :clip-far 1024
                                               :zoom 100)))
  ...
  (("cube-z-1" :copy "/mesh")
   (comp.transform:transform :translate (v3:vec 0 0 -4))
   (comp.mesh.static:static-mesh :location '((:core :mesh) "cube.glb")))

  (("cube-z-0" :copy "/mesh")
   (comp.transform:transform :translate (v3:vec 0 0 -2))
   (comp.mesh.static:static-mesh :location '((:core :mesh) "cube.glb")))

  (("cube-origin" :copy "/mesh")
   (comp.transform:transform #++ :rotate/inc #++ (q:orient :local
  ...
  (("cube-x-1" :copy "/mesh")
   (comp.transform:transform :translate (v3:vec 4 0 0))
   (comp.mesh.static:static-mesh :location '((:core :mesh) "cube.glb"))))

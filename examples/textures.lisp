...
(fl:define-texture texture-test/testcubemap (:texture-cube-map)
  (:data
...
(fl:define-texture texture-test/testcubemaparray (:texture-cube-map-array)
  (:data
...
;;(fl:define-texture test/texture-2d (:texture-2d)
;;  (:data (vector (general-data-descriptor ....))))

#++(fl:define-texture test/texture-3d (:texture-3d)
...
#++(fl:define-texture test/texture-rectangle (:texture-rectangle)
     ;; the data is stored in a traditional image. no mipmaps allowed
     (:data #("data/test/test-texture-rectangle.tiff")))

#++(fl:define-texture test/texture-rectangle-data (:texture-rectangle)
...
#++(fl:define-texture test/texture-2d-array (:texture-2d-array)
...
#++(fl:define-texture test/texture-buffer (:texture-buffer)
     nil)

...
(c:define-texture-map name (:single :unique) ;; The data model
  ...
  ;; D :top-left
  ;; D :bottom-left-back when :storage is (:3d ...)!
  ;;
...
(c:define-texture-map red-line (:1d :unique)
  (texmap:mipmap (textures red-line-0))
  (texmap:mipmap (textures red-line-1))
  (texmap:mipmap (textures red-line-2))
  (texmap:mipmap (textures red-line-3)))

(c:define-texture-map green-line (:1d :unique)
  (texmap:mipmap (textures green-line-0))
  (texmap:mipmap (textures green-line-1))
  (texmap:mipmap (textures green-line-2))
  (texmap:mipmap (textures green-line-3)))

(c:define-texture-map blue-line (:1d :unique)
  (texmap:mipmap (textures blue-line-0))
  (texmap:mipmap (textures blue-line-1))
  (texmap:mipmap (textures blue-line-2))
  (texmap:mipmap (textures blue-line-3)))

(c:define-texture-map white-line (:1d :unique)
  (texmap:mipmap (textures white-line-0))
  (texmap:mipmap (textures white-line-1))
  (texmap:mipmap (textures white-line-2))
  (texmap:mipmap (textures white-line-3)))
...
(c:define-texture-map blue-fur (:2d :unique)
  (texmap:mipmap (textures blue-fur-0))
  (texmap:mipmap (textures blue-fur-1))
  (texmap:mipmap (textures blue-fur-2))
  (texmap:mipmap (textures blue-fur-3))
  (texmap:mipmap (textures blue-fur-4))
  (texmap:mipmap (textures blue-fur-5))
  (texmap:mipmap (textures blue-fur-6))
  (texmap:mipmap (textures blue-fur-7))
  (texmap:mipmap (textures blue-fur-8))
  (texmap:mipmap (textures blue-fur-9))
  (texmap:mipmap (textures blue-fur-10)))

(c:define-texture-map bark (:2d :unique)
  (texmap:mipmap (textures bark-0))
  (texmap:mipmap (textures bark-1))
  (texmap:mipmap (textures bark-2))
  (texmap:mipmap (textures bark-3))
  (texmap:mipmap (textures bark-4))
  (texmap:mipmap (textures bark-5))
  (texmap:mipmap (textures bark-6))
  (texmap:mipmap (textures bark-7))
  (texmap:mipmap (textures bark-8))
  (texmap:mipmap (textures bark-9))
  (texmap:mipmap (textures bark-10)))

(c:define-texture-map rock (:2d :unique)
  (texmap:mipmap (textures rock-0))
  (texmap:mipmap (textures rock-1))
  (texmap:mipmap (textures rock-2))
  (texmap:mipmap (textures rock-3))
  (texmap:mipmap (textures rock-4))
  (texmap:mipmap (textures rock-5))
  (texmap:mipmap (textures rock-6))
  (texmap:mipmap (textures rock-7))
  (texmap:mipmap (textures rock-8))
  (texmap:mipmap (textures rock-9))
  (texmap:mipmap (textures rock-10)))

(c:define-texture-map wiggles (:2d :unique)
  (texmap:mipmap (textures wiggles-0))
  (texmap:mipmap (textures wiggles-1))
  (texmap:mipmap (textures wiggles-2))
  (texmap:mipmap (textures wiggles-3))
  (texmap:mipmap (textures wiggles-4))
  (texmap:mipmap (textures wiggles-5))
  (texmap:mipmap (textures wiggles-6))
  (texmap:mipmap (textures wiggles-7))
  (texmap:mipmap (textures wiggles-8))
  (texmap:mipmap (textures wiggles-9))
  (texmap:mipmap (textures wiggles-10)))
...
(c:define-texture-map cube-map (:cube :unique :six)
  ...
  (texmap:face (texmap:dir :-y) cube-map-bottom)
  (texmap:face (texmap:dir :+z) cube-map-back)
  (texmap:face (texmap:dir :-z) cube-map-front))
...
(c:define-texture-map cube-map-right-2 (:2d :unique)
  (texmap:mipmap (textures cube-map-right)))

(c:define-texture-map cube-map-left-2 (:2d :unique)
  (texmap:mipmap (textures cube-map-left-2)))

(c:define-texture-map cube-map-top-2 (:2d :unique)
  (texmap:mipmap (textures cube-map-top-2)))

(c:define-texture-map cube-map-bottom-2 (:2d :unique)
  (texmap:mipmap (textures cube-map-bottom-2)))

(c:define-texture-map cube-map-back-2 (:2d :unique)
  (texmap:mipmap (textures cube-map-back-2)))
...
(c:define-texture-map cube-map-2 (:cube :unique :six)
  ...
  (texmap:face (texmap:dir :-y) cube-map-bottom-2)
  (texmap:face (texmap:dir :+z) cube-map-back-2)
  (texmap:face (texmap:dir :-z) cube-map-front-2))

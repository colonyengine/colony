...
;; Name: cube
;; Model (:cube :faces :six)
;;; --------------------------------------------------------

;; This logical form, which is almost certainly what humans will mostly write.
(c:define-texture-map g000-cube-log-inf-one-non (:cube :faces :six)
...
;; |
;; v
(c:define-texture-map g000-cube-phy-gnd-one-non (:cube :faces :six)
  (c:data-elements
...
;;; This one is unimplemented because we force those face texture-maps
...
;; This logical form, which is almost certainly what humans will mostly write.
#++(c:define-texture-map g003-cube-log-inf-one-non (:cube :faces :six)
     (c:face (c:dir :+x)
